...
1. Vi seu comentário no post do Imersivo. Você já tem uma ideia ou projeto em mente?
2. Hoje ela está em que fase: rascunho, projeto iniciado ou processo manual?
3. Quer que eu te envie as informações da turma de 28, 29 e 30 de agosto no Refúgio INEMA?

## Sequência de conteúdo

1. Diagnóstico: mostra o custo da ideia parada.
2. Transformação: mostra como a ideia avança em três dias.
3. Convite: apresenta escassez real, local, data e perfil de participante.
4. Stories: repete a pergunta de qualificação e puxa comentário/DM.
